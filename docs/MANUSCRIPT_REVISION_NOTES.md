...
* The scope statement: the formalization covers exact algebra, and claims no end-to-end
  verification of the stochastic differential equation. (Since this note was written, the
  formalization has been extended to the residual-variance threshold and to the algebraic Lyapunov
  facts about the explicit `Σ`; the disclaimer about the stochastic differential equation is
  unchanged.)
